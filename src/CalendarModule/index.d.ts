...
export type CalendarAccessLevelAndroid = 'contributor' | 'editor' | 'freebusy' | 'override' | 'owner' | 'read' | 'respond' | 'root';
...
export default class ReactNativeCalendarEvents {
     ...
     */
    static fetchAllEvents(startDate: ISODateString, endDate: ISODateString, calendarIds?: string[]): Promise<CalendarEventReadable[]>;
    /**
     ...
     */
    static saveEvent(title: string, details: CalendarEventWritable, options?: Options): Promise<string>;
    /**
